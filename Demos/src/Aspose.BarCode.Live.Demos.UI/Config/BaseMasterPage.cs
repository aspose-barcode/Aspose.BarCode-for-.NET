...
namespace Aspose.Barcode.Live.Demos.UI.Config
{
    ...
    {
        private AsposeBarCodeContext _atContext;
        ...
        public AsposeBarCodeContext AsposeBarCodeContext
		{
            get
            {
                if (_atContext == null) _atContext = new AsposeBarCodeContext(HttpContext.Current);
                return _atContext;
            }
        }
		...
		protected override void OnLoad(EventArgs e)
        {
			...
			AsposeBarCodeContext.atcc = AsposeBarCodeContext;
            base.OnLoad(e);
        }
    }
}

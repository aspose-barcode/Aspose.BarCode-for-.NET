...
namespace Aspose.Barcode.Live.Demos.UI.Config
{
	...
	{		
		...
		private static string _AsposeBarCodeLiveDemosPath = ConfigurationManager.AppSettings["AsposeBarCodeLiveDemosPath"].ToString();
		...
		private static string _AsposeBarCodeAppsAssetURL = ConfigurationManager.AppSettings["AsposeBarCodeAppsAssetURL"];
		...
		public static string AsposeBarCodeLiveDemosPath
		{
			get { return _AsposeBarCodeLiveDemosPath; }
		}	
        ...
        public static string AsposeBarCodeAppsAssetURL
		{
            get { return _AsposeBarCodeAppsAssetURL; }
        }

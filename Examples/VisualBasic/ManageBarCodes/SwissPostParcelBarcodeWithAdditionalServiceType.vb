...
Namespace Aspose.BarCode.Examples.VisualBasic.ManageBarCodes
	Class SwissPostParcelBarcodeWithAdditionalServiceType
		Public Shared Sub Run()
			...
			Dim builder As New BarCodeBuilder("989967121212121212", EncodeTypes.SwissPostParcel)

			builder.Save(dataDir & Convert.ToString("SwissPostParcelBarcodeWithAdditionalServiceType_out.Png"))

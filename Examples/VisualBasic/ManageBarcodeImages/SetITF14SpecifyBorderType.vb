...
Namespace Aspose.BarCode.Examples.VisualBasic.ManageBarCodeImages
    Class SetITF14SpecifyBorderType
        Public Shared Sub Run()
            ...
            ' Instantiate barcode object and set CodeText, Barcode Symbology and Set Different properties
            ...
            BarCodeBuilder.Save(dataDir & Convert.ToString("ITF14_Border_Type_Bar_out.png"), BarCodeImageFormat.Png)
        End Sub
    End Class
End Namespace
...
{
    internal class CellsIntegrationBase
    {
        protected const string _AsposeLibrariesPath = "Aspose";
        protected static string GetReadFolder()
        {
            return BarcodePathUtils.GetDataDir_Folders(_AsposeLibrariesPath, "Cells");
        }
        protected static string GetWriteFolder()
        {
            return BarcodePathUtils.GetDataDir_Data_Output(_AsposeLibrariesPath, "Cells");
        }
    }
}
...
namespace Aspose.BarCode.Examples.CSharp.GenerationExamples
{
    class SetHeightBarcodeBars
    {
        public static void Run()
        {
            ...
            generator.Save(dataDir + "Code128-bar-height3mm_out.jpg", BarCodeImageFormat.Jpeg);
            ...
            generator.Save(dataDir + "Code128-bar-height7mm_out.jpg", BarCodeImageFormat.Jpeg);

            // Set the bar height to 3 millimeters and  Save the image to disk
            generator.Parameters.Barcode.BarHeight.Millimeters = 11.0f;
            generator.Save(dataDir + "Code128-bar-height11mm_out.jpg", BarCodeImageFormat.Jpeg);
